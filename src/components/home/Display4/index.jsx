...
export const Display4 = () => {
  ...
  return (
    <section className="mt-[2.5rem] bg-[#000000] py-3 md:mt-[10rem]">
      ...
      <ul className="hidden xl:grid-cols-2 justify-items-center gap-8 md:grid w-fit m-auto">
        <li className="relative box-border flex  h-[275.69px] w-[588px] items-center justify-center overflow-hidden rounded-lg bg-[#ffffff00] p-[10px]">
            <figure className="m-0 flex w-full items-center justify-center">
              <img
                src={solaz}
                alt="SOLAZ web"
                className={`absolute left-0 top-0 h-full w-full rounded-[8px] object-cover transition-all duration-1000  ${estaSobreImagen.clima && 'hover:z-10'
                  } ${estaSobreImagen.clima && 'opacity-80'} ${estaSobreImagen.clima && 'scale-[1.2]'
                  } ${estaSobreImagen.clima && 'blur-[2px]'}`}
                onMouseEnter={() => manejarMouseSobreImagen('clima')}
                onMouseLeave={() => manejarMouseFueraImagen('clima')}
              />
              <figcaption
                className={`${estaSobreImagen.clima ? 'w-full' : 'invisible'
                  } flex flex-col items-center justify-center gap-4`}
              >
                <div
                  className={`${estaSobreImagen.clima ? 'z-20' : 'invisible'
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[0.75rem] text-[#FFFFFFFF]">
                      <b className="text-[1rem]">{t('display_4.tecno')}</b>Typescript, NextJS,
                ...
                >
                  <a
                    ...
                    target=" _blank"
                    className={`${estaSobreImagen.clima
          ...
          <li className="relative box-border flex h-[275.69px] w-[588px] items-center justify-center overflow-hidden rounded-lg bg-[#ffffff00] p-[10px]">
            <figure className="m-0 flex w-full items-center justify-center">
              <img
                src={refugio}
                alt="Refugio"
                className={`absolute left-0 top-0 h-full w-full rounded-[8px] object-cover transition-all duration-1000  ${estaSobreImagen.refugio && 'hover:z-10'
                  } ${estaSobreImagen.refugio && 'opacity-80'} ${estaSobreImagen.refugio && 'scale-[1.2]'
                  } ${estaSobreImagen.refugio && 'blur-[2px]'}`}
                onMouseEnter={() => manejarMouseSobreImagen('refugio')}
                onMouseLeave={() => manejarMouseFueraImagen('refugio')}
              />
              <figcaption
                className={`${estaSobreImagen.refugio ? 'w-full' : 'invisible'
                  } flex flex-col items-center justify-center gap-4`}
              >
                <div
                  className={`${estaSobreImagen.refugio ? 'z-20' : 'invisible'
                    } flex h-[10rem] w-[25rem] flex-col items-center justify-center gap-3 rounded-lg bg-[#8080804f] p-2 backdrop-blur-lg`}
                  onMouseEnter={() => manejarMouseSobreImagen('refugio')}
                >
                  <h4 className="border-b-2 border-solid border-white text-[1.5rem] font-bold text-[#FFFFFFFF]">
                ...
                >
                  <a
                    ...
                    target=" _blank"
                    className={`${estaSobreImagen.refugio
                      ? 'z-20 bg-[#8080804f] backdrop-blur-lg'
                      : 'invisible'
                      } group flex w-[10rem] flex-row items-center justify-center rounded-lg py-2`}
                    onMouseEnter={() => manejarMouseSobreImagen('refugio')}
          ...
          <li className="relative box-border flex  h-[275.69px] w-[588px] items-center justify-center overflow-hidden rounded-lg bg-[#ffffff00] p-[10px]">
            <figure className="m-0 flex w-full items-center justify-center">
              <img
                src={food}
                alt="food"
                className={`absolute left-0 top-0 h-full w-full rounded-[8px] object-cover transition-all duration-1000 ${estaSobreImagen.food && 'hover:z-10'
                  } ${estaSobreImagen.food && 'opacity-80'} ${estaSobreImagen.food && 'scale-[1.2]'
                  } ${estaSobreImagen.food && 'blur-[2px]'}`}
                onMouseEnter={() => manejarMouseSobreImagen('food')}
                onMouseLeave={() => manejarMouseFueraImagen('food')}
              />
              <figcaption
                className={`${estaSobreImagen.food ? 'w-full' : 'invisible'
                  } flex flex-col items-center justify-center gap-4`}
              >
                <div
                  className={`${estaSobreImagen.food ? 'z-20' : 'invisible'
                    } flex h-[10rem] w-[25rem] flex-col items-center justify-center gap-3 rounded-lg bg-[#8080804f] p-2 backdrop-blur-lg`}
                  onMouseEnter={() => manejarMouseSobreImagen('food')}
                >
                  <h4 className="border-b-2 border-solid border-white text-[1.5rem] font-bold text-[#FFFFFFFF]">
                ...
                >
                  <a
                    ...
                    target=" _blank"
                    className={`${estaSobreImagen.food
                      ? 'z-20 bg-[#8080804f] backdrop-blur-lg'
                      : 'invisible'
                      } group flex w-[10rem] flex-row items-center justify-center rounded-lg py-2`}
                    onMouseEnter={() => manejarMouseSobreImagen('food')}
          ...
          <li className="relative box-border flex  h-[275.69px] w-[588px] items-center justify-center overflow-hidden rounded-lg bg-[#ffffff00] p-[10px]">
            <figure className="m-0 flex w-full items-center justify-center">
              <img
                src={movie}
                alt="movie"
                className={`absolute left-0 top-0 h-full w-full rounded-[8px] object-cover transition-all duration-1000  ${estaSobreImagen.movie && 'hover:z-10'
                  } ${estaSobreImagen.movie && 'opacity-90'} ${estaSobreImagen.movie && 'scale-[1.2]'
                  } ${estaSobreImagen.movie && 'blur-[2px]'}`}
                onMouseEnter={() => manejarMouseSobreImagen('movie')}
                onMouseLeave={() => manejarMouseFueraImagen('movie')}
              />
              <figcaption
                className={`${estaSobreImagen.movie ? 'w-full' : 'invisible'
                  } flex flex-col items-center justify-center gap-4`}
              >
                <div
                  className={`${estaSobreImagen.movie ? 'z-20' : 'invisible'
                    } flex h-[10rem] w-[25rem] flex-col items-center justify-center gap-3 rounded-lg bg-[#8080804f] p-2 backdrop-blur-lg`}
                  onMouseEnter={() => manejarMouseSobreImagen('movie')}
                >
                  <h4 className="border-b-2 border-solid border-white text-[1.5rem] font-bold text-[#FFFFFFFF]">
                ...
                >
                  <a
                    ...
                    target=" _blank"
                    className={`${estaSobreImagen.movie
                      ? 'z-20 bg-[#8080804f] backdrop-blur-lg'
                      : 'invisible'
                      } group flex w-[10rem] flex-row items-center justify-center rounded-lg py-2`}
                    onMouseEnter={() => manejarMouseSobreImagen('movie')}
